...
hl.env("HYPRSHOT_DIR", "/home/moonixiali/Pictures/")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(3d5c54ff)", "rgba(71a79fff)"}, angle = 45 },
          inactive_border = "rgba(001609f0)",
        },
...
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("hyprshot -m region --freeze"))
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen("maximized", "toggle"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("swaync-client -t -sw"))
